<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Anasayfa.aspx.cs" Inherits="HTML_5_Tema_Projesi.Anasayfa" %>
...
<html lang="en">
	<head>
		...
		<title>Eczaneler || Yaren Ve Şifa</title>
		...
		<div class="main-page-wrapper">
					...
					<nav class="navbar float-right theme-main-menu one-page-menu">
					   ...
					   <div class="collapse navbar-collapse" id="navbar-collapse-1">
					     <ul class="nav navbar-nav">
							...
							<li><a href="#team-section">Takım</a></li>
							...
							<ul>
								...
								<li data-index="rs-280" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default"  data-title="Title Goes Here" data-description="">
									...
									<div class="tp-caption"
										...
										data-splitout="none" 
										data-responsive_offset="on">
										<a href="contact-us.html" class="project-button hvr-bounce-to-right">Diğer Hizmetlerimiz</a>
									</div>
			...
			<section id="about-us">
				<div class="container">
					<div class="theme-title">
						<h2>Eczaneler Hakkında</h2>
						<p>En İyi Kalite Ve Hizmetimizle Hastalarımızı Memnun Etmeye Devam Ediyoruz.</p>
					</div> <!-- /.theme-title -->
					...
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="single-about-content">
								...
								<h5><a href="#" class="tran3s">Reçeteler</a></h5>
								<p>Reçetelerinizi Görüntüleyebilirsiniz</p>
								<a href="#" class="more tran3s hvr-bounce-to-right">Detaylar</a>
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="single-about-content">
								...
								<h5><a href="#" class="tran3s">Fotoğraflar</a></h5>
								<p>İlaç ve Tedarik Görsellerini Görüntüleyebilirsiniz</p>
								<a href="#" class="more tran3s hvr-bounce-to-right">Detaylar</a>
							</div> <!-- /.single-about-content -->
						</div> <!-- /.col -->
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="single-about-content">
								...
								<h5><a href="#" class="tran3s">Sosyal Medya</a></h5>
								<p>Sosyal Medya Hesabınızla Bize Destek Olabilirsiniz</p>
								<a href="#" class="more tran3s hvr-bounce-to-right">Detaylar</a>
							</div> <!-- /.single-about-content -->
						</div> <!-- /.col -->
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="single-about-content">
								...
								<h5><a href="#" class="tran3s">Online Alışveriş</a></h5>
								<p>Online Alışverişle İlacınızı Evde Kalarak Alabilirsiniz</p>
								<a href="#" class="more tran3s hvr-bounce-to-right">Detaylar</a>
							</div> <!-- /.single-about-content -->
						</div> <!-- /.col -->
					</div> <!-- /.row -->
			...
			<div id="service-section">
				<div class="container">
					<div class="theme-title">
						<h2>Hizmetlerimiz</h2>
						<p>2015'den Beri Hastalarımız Saygı ve Sevgiyle Memnun Etmeye Devam Ediyoruz</p>
					</div> <!-- /.theme-title -->
			...
			<div class="page-middle-banner">
				<div class="opacity">
					<h3>Yaralarınızı Sarıyoruz <span class="p-color">&amp;</span> En İyi Karışımlar</h3>
					<a href="#" class="hvr-bounce-to-right">Birlikte Çalışalım</a>
				</div> <!-- /.opacity -->
			...
			<div id="team-section">
				<div class="container">
					<div class="theme-title">
						...
						<p>Biz Çalışanlarımızla Aile Olmak İçin Çabalıyoruz</p>
					</div> <!-- /.theme-title -->
			...
			<div id="our-client">
				<div class="container">
					<div class="theme-title">
						<h2>Memnun Dönüşlerimiz</h2>
						<p>Hastalarımızın Memnuniyetinden Biz de Memnunuz.</p>
					</div> <!-- /.theme-title -->
